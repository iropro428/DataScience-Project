...
[data-testid="stSidebar"] [data-testid="stPageLink"] a[aria-current="page"] {
    ...
    box-shadow: 0 0 0 1px var(--primary-d),
...
/* Reset default heading styles inside the custom page header */
.page-header h1 {
    all: unset;
}
...
.rq-box {
    background: linear-gradient(135deg, #4f58b0 0%, #bbc0c9 100%);
...
def apply_styles():
    """Inject the shared global CSS styles into the Streamlit app."""
